...
interface NdMonogramIconProps {
  className?: string;
}

export const NdMonogramIcon: FC<Readonly<NdMonogramIconProps>> = ({
  className,
}) => (
  <svg
    className={className}
