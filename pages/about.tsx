        ...
        <div className="mt-8">
          <div className="inline">
            ...
            <p>
              ...
              who is motivated towards delivering commercial outcomes, so I
              enjoy working across the entire stack and using whatever tools it
              takes to build something awesome.
              <NewLine />
